...
class HandDetector:
    ...
    def fingers_up(self):
        ...
        # Thumb: check x-axis (left or right of previous point)
...
def main():
    p_time = 0
    cap = cv2.VideoCapture(1)  # Webcam index 1 (change to 0 if needed)
    ...
    while True:
        ...
        if len(lm_list) != 0:
            print(f"Landmark 4 (thumb tip) position: {lm_list[4]}")
